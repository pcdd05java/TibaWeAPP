...
class CampusZoneAdapter extends RecyclerView.Adapter<CampusZoneAdapter.ViewHolder> {
    ...
    public CampusZoneAdapter(int[] informations, int[] imageIds){
    ...
    @NonNull
    @Override
    public CampusZoneAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
