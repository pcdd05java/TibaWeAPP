...
public class ClassroomReserveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_classroom_reserve);
    ...
    private class ClassroomReservePagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:
                    return new ClassroomReserveFragment();
                case 1:
                    return new ClassroomQueryFragment();
            }
            return null;
        }
