...
class ClrrAdapter extends RecyclerView.Adapter<ClrrAdapter.ViewHolder> {
    ...
    public ClrrAdapter(List<ClrrVO> clrrVOList, String membername){
    ...
    @NonNull
    @Override
    public ClrrAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
