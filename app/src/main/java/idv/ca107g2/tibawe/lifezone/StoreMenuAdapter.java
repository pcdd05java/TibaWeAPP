...
class StoreMenuAdapter extends RecyclerView.Adapter<StoreMenuAdapter.ViewHolder> {
    ...
    public StoreMenuAdapter(String[] informations, int[] imageIds){
    ...
    @NonNull
    @Override
    public StoreMenuAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
