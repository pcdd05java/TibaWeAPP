...
public class SpinnerTask extends AsyncTask<String, Integer, List<CrVO>> {
    private static final String TAG = "SpinnerTask";

    @Override
    protected List<CrVO> doInBackground(String... strings) {
        ...
        try {
            ...
            String content = "action=getAllOpenCr";
        ...
        if (sb != null) {
            // decode JSON to List<CrVO>
            Gson gson = new Gson();
            Type listType = new TypeToken<List<CrVO>>() {
            }.getType();
